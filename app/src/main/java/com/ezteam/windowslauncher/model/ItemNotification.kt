...
data class ItemNotification(
    ...
    companion object CREATOR : Parcelable.Creator<ItemNotification> {
        override fun createFromParcel(parcel: Parcel): ItemNotification {
            return ItemNotification(parcel)
        }

        override fun newArray(size: Int): Array<ItemNotification?> {
