...
import com.ezteam.baseproject.view.zoomview.ZoomApi
import com.ezteam.baseproject.view.zoomview.ZoomLogger
import com.ezteam.baseproject.view.zoomview.matrix.MatrixController
import com.ezteam.baseproject.view.zoomview.movement.PanManager
...
internal class ScrollFlingDetector(
    ...
    override fun onFling(
        ...
        @ZoomApi.ScaledPan val overScrollX =
            if (panManager.horizontalOverPanEnabled) panManager.maxHorizontalOverPan else 0F
        @ZoomApi.ScaledPan val overScrollY =
            if (panManager.verticalOverPanEnabled) panManager.maxVerticalOverPan else 0F
        ...
        matrixController.post(object : Runnable {
            override fun run() {
                if (flingScroller.isFinished) {
                    ...
                    val newPan =
                        ScaledPoint(flingScroller.currX.toFloat(), flingScroller.currY.toFloat())
