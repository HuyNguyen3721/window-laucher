...
public class RemoteKey {
    public static final String ENABLE_START_APP_ADS = "enable_start_app_ads";
    public static final String ENABLE_OVERLAY_FB_ADS = "enable_overlay_fb_ads";
    public static final String COUNT_CLICK_BANNER = "count_click_banner";
