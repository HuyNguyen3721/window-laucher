...
public class EzAdControl {
    ...
    private void loadApplovin() {
        ...
        ApplovinUtils.getInstance(mContext)
                .setListener(new AdFactoryListener() {
                    ...
                    @Override
                    public void onLoaded() {
                        LogUtils.logString(EzAdControl.class, "Applovin onLoaded");
                        setOnAdLoaded();
                    }
    ...
    private boolean isloading() {
        return FacebookUtils.getInstance(mContext).isLoading() || AdmobUtils.getInstance(mContext).isLoading() || ApplovinUtils.getInstance(mContext).isLoading();
    }
